...
VOID SimpleShaders::Initialize( const CHAR* strShaderFileName, FXLEffectPool* pEffectPool )
{
    ...
    // create vertex decls
    g_pSimpleShadersDevice->CreateVertexDeclaration( g_PosVertexElements, &g_pVertexDeclPos );
    g_pSimpleShadersDevice->CreateVertexDeclaration( g_PosColorVertexElements, &g_pVertexDeclPosColor );
    g_pSimpleShadersDevice->CreateVertexDeclaration( g_PosTVertexElements, &g_pVertexDeclPosT );
    g_pSimpleShadersDevice->CreateVertexDeclaration( g_PosTexCoordVertexElements, &g_pVertexDeclPosTexCoord );
    g_pSimpleShadersDevice->CreateVertexDeclaration( g_PosColorTexCoordVertexElements, &g_pVertexDeclPosColorTexCoord );
